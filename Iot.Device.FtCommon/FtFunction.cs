...
namespace Iot.Device.FtCommon
{
    ...
    internal class FtFunction
    {
        ...
        /// </summary>
        /// <param name="ftHandle">The handle of the open device</param>
        /// <param name="dwBaudRate">The baud rate</param>
        /// <returns></returns>
        [DllImport("ftd2xx")]
        public static extern FtStatus FT_SetBaudRate(SafeFtHandle ftHandle, uint dwBaudRate);

        /// <summary>
        /// Sets data characteristics (data bits, stop bits, parity).
        /// </summary>
        /// <param name="ftHandle">The handle of the open device</param>
        /// <param name="uWordLength">Number of data bits (7 or 8)</param>
        /// <param name="uStopBits">Stop bits (0=1, 1=1.5, 2=2)</param>
        /// <param name="uParity">Parity (0=None, 1=Odd, 2=Even, 3=Mark, 4=Space)</param>
        /// <returns></returns>
        [DllImport("ftd2xx")]
        public static extern FtStatus FT_SetDataCharacteristics(SafeFtHandle ftHandle, byte uWordLength, byte uStopBits, byte uParity);

        /// <summary>
        /// Purge receive and/or transmit buffers.
        /// </summary>
        /// <param name="ftHandle">The handle of the open device</param>
        /// <param name="dwMask">Combination of FT_PURGE_RX (1) and FT_PURGE_TX (2)</param>
        /// <returns></returns>
        [DllImport("ftd2xx")]
        public static extern FtStatus FT_Purge(SafeFtHandle ftHandle, uint dwMask);
    }
}
